...
from design_tool.engine import DesignEngine, STATE_LABELS
from design_tool.exporter import export_preview_lines, safe_file_name, write_export
from design_tool.framework_memory import import_memory_archive
from design_tool.gameplay_systems import parse_interview_answers_to_custom_systems
from design_tool.project_templates import custom_template_path, list_project_templates, save_custom_template, target_scale_options
from design_tool.profile_schema import PROFILE_FIELDS, field_label, option_label, value_from_label
from design_tool.ui.ai_interview_window import AIInterviewWindow
from design_tool.ui.theme import COLORS, FONT_BADGE, FONT_BODY, FONT_CARD, FONT_SECTION, FONT_SMALL, FONT_TITLE
...
class CommercialDesignApp(tk.Tk):
    ...
    def add_custom_gameplay_system(self, name_var):
        ...
        from design_tool.gameplay_systems import normalize_custom_system
