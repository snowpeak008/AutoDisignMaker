...
from design_tool.ai_prompt_packer import (
    build_prompt_text,
    compact_json,
...
from design_tool.ai_memory_retriever import retrieved_memory_context
from design_tool.ai_route_planner import candidate_node_ids as route_candidate_node_ids
