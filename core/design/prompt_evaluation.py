...
from core.design.ai_backend import CodexCliBackend, CodexUnavailableError, codex_available
from core.design.ai_interview import build_interview_prompt, ensure_ai_interview
from core.design.ai_schema import AI_RESPONSE_SCHEMA
from core.design.ai_validator import validate_ai_response_payload, validate_full_project_output
from core.design.data_loader import load_project_data, runtime_project_root
from core.design.engine import DesignEngine
from core.design.framework_memory import append_jsonl, append_memory_log, memory_paths, read_jsonl
from core.design.prompt_framework import compose_prompt_framework, prompt_version_snapshot
...
def evaluation_dir(runtime_root=None):
    return Path(runtime_root or runtime_project_root()) / "knowledge" / "design_data" / "prompt_evaluation"
