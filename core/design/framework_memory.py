...
from core.design.prompt_framework import (
...
def synthesize_candidate_diff(runtime_root, module_id, signal_type, events):
    ...
    try:
        ...
        from core.design.prompt_framework import compose_prompt_framework, validate_structured_diff
...
def aggregate_memory(runtime_root):
    ...
    for (module_id, signal_type, rule_id), signals in by_global_signal.items():
        ...
        if validation_errors:
            ...
            continue
        try:
            from core.design.prompt_evaluation import promotion_gate_decision
