"""Load structured handoff contracts — migrated from tools/handoff_loader.py."""
...
from core.source.folder_manager import find_latest
...
def load_design_sources(design_doc_path: Path) -> dict[str, Any]:
    ...
    markdown = design_doc_path.read_text(encoding="utf-8") if design_doc_path.exists() and design_doc_path.is_file() else ""
    return {
