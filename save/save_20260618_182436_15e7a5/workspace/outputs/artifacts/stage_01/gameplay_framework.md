...
- RES-001 资源：Python modules, JSON schemas, TOML configuration, Markdown documents, Unity project settings, and PyInstaller build output storage=none producers=['SEL-008', 'SEL-009', 'SEL-010', 'SEL-011'] consumers=['SEL-008', 'SEL-009', 'SEL-010', 'SEL-011']
